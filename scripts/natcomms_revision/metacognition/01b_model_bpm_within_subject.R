...
#        BPM_scaled = within-subject scaled listenBPM (centered + standardized per subject)
...
# Subject-mean-center Stimulus intensity
...
cat("Note: Stimulus_c = subject-mean-centered stimulus intensity\n")
cat("Family: ordbeta()\n")
