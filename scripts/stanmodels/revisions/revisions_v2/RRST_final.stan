...
model{
  ...
  target += normal_lpdf(gm[2] | 0, 3); //global mean of difference between beta
  target += normal_lpdf(gm[3] | 0, 3); //global mean of difference between beta
  target += normal_lpdf(gm[4] | 0, 3); //global mean of average HR on beta
  target += normal_lpdf(gm[5] | 0, 3); //global mean of average HRV  beta
  
  target += normal_lpdf(gm[6] | -4,2); //global mean of lapse
  target += normal_lpdf(gm[7] | 0,1); //global mean of difference between lapse
  target += normal_lpdf(gm[8] | 0,1); //global mean of difference between lapse

  
  target += normal_lpdf(gm[9] | 10,10); //global mean of alpha
  
  target += normal_lpdf(gm[10] | 0,5); //global mean of difference between alpha
  
  target += normal_lpdf(gm[11] | 0,5); //global mean of difference between alpha

  target += normal_lpdf(gm[12] | 0,5); //global mean of average HR on alpha
  target += normal_lpdf(gm[13] | 0,5); //global mean of average HRV on alpha
  
  target += normal_lpdf(gm[14] | 0,3); //global mean of prediction effect on beta
  target += normal_lpdf(gm[15] | 0,1); //global mean of prediction effect on lapse
  target += normal_lpdf(gm[16] | 0,5); //global mean of prediction effect on alpha
