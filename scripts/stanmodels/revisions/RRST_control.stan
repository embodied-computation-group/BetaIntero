...
model{
  ...
  target += normal_lpdf(gm[8] | 10,10); //global mean of guess
  
  target += normal_lpdf(gm[9] | 0,5); //global mean of alpha
  
  target += normal_lpdf(gm[10] | 0,5); //global mean of alpha_dif
